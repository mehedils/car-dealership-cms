<div class="background-100 pb-70">
	<div class="container">
		<div class="box-search-category">
			<h3 class="heading-3 mb-0 neutral-1000 wow fadeInUp">{{ __(setting('home_brands_title', 'Premium Brands')) }}</h3>
			<div class="d-flex align-items-center justify-content-between mb-4">
				<p class="text-lg-medium neutral-500 mb-0 wow fadeInUp">{{ __(setting('home_brands_subtitle', 'Unveil the Finest Selection of High-End Vehicles')) }}</p>
				<a href="{{ url('/cars') }}" class="text-sm-bold neutral-1000 d-inline-flex align-items-center gap-2 link-hover-primary wow fadeInUp">
					<span>{{ __(setting('home_brands_button_text', 'Show All Brands')) }}</span>
