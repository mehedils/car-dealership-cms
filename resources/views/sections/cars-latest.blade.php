	...
	<div class="container">
		<div class="row align-items-center mb-40">
			<div class="col-md-8 wow fadeInUp">
				<h3 class="title-svg neutral-1000 mb-2">{{ setting('home_latest_title', 'Latest Arrivals') }}</h3>
				<p class="text-lg-medium text-bold neutral-500 mb-0">{{ setting('home_latest_subtitle', 'Check out the newest additions to our inventory') }}</p>
			</div>
