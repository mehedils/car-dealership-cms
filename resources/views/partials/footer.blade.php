            ...
            <div class="col-md-3 col-sm-12 footer-1">
                <div class="mt-20 mb-20">
                    ...
                    <div class="box-info-contact mt-0">
                        <p class="text-md neutral-400 icon-address">2356 Oakwood Drive, Suite 18, San Francisco,
                    ...
                    <div class="box-need-help">
                        ...
                        <br><a class="heading-6 phone-support" href="tel:+12225553399">+1 222-555-33-99</a>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-bottom mt-50">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6 text-md-start text-center mb-20">
                    <p class="text-sm color-white">© {{ date('Y') }} Carento Inc. All rights reserved.</p>
                </div>
