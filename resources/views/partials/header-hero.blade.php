        ...
        <div class="container-fluid">
            ...
            <div class="text-header topbar-announcement-ticker" style="position: relative; overflow: hidden; min-height: 38px; display: flex; align-items: center; justify-content: center;">
                @if(count($announcements) > 0)
                    ...
                    @endforeach
                @else
                    <div class="text-unlock text-sm-medium text-white d-flex align-items-center"><i class="fi fi-rr-car me-2"></i><span>{{ setting('site_slogan', 'More than 800+ special collection cars in this summer') }}</span></div>
        ...
        if (items.length > 1) {
            ...
            setInterval(function() {
                ...
                setTimeout(function() {
                    ...
                    nextItem.style.removeProperty('display');
                    nextItem.classList.add('d-flex');
                    setTimeout(function() {
