    ...
    <section class="box-section box-breadcrumb background-body">
        <div class="container">
            <ul class="breadcrumbs">
                ...
                <li>
                    <span class="text-breadcrumb">Hyundai Accent 2025 </span>
                </li>
            </ul>
        </div>
    </section>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="tour-title-main">
                            <h4 class="neutral-1000">Hyundai Accent 2015 - Modern compact sedan in blue color on beautiful dark wheels</h4>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="list-feature-car align-items-start">
                            <div class="item-feature-car w-md-25">
                                <div class="item-feature-car-inner">
                                    ...
                                    <div class="feature-info">
                                        <p class="text-md-medium neutral-1000">56,500</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-feature-car w-md-25">
                                <div class="item-feature-car-inner">
                                    ...
                                    <div class="feature-info">
                                        <p class="text-md-medium neutral-1000">Diesel</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-feature-car w-md-25">
                            ...
                            <div class="item-feature-car w-md-25">
                                <div class="item-feature-car-inner">
                                    ...
                                    <div class="feature-info">
                                        <p class="text-md-medium neutral-1000">7 seats</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-feature-car w-md-25">
                            ...
                            <div class="item-feature-car w-md-25">
                                <div class="item-feature-car-inner">
                                    ...
                                    <div class="feature-info">
                                        <p class="text-md-medium neutral-1000">SUVs</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-feature-car w-md-25">
                                <div class="item-feature-car-inner">
                                    ...
                                    <div class="feature-info">
                                        <p class="text-md-medium neutral-1000">4 Doors</p>
                                    </div>
                                </div>
                            </div>
                            <div class="item-feature-car w-md-25">
                                <div class="item-feature-car-inner">
                                    ...
                                    <div class="feature-info">
                                        <p class="text-md-medium neutral-1000">2.5L</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="booking-form">
                        ...
                        <div class="content-booking-form">
                                            ...
                                            <ul class="list-filter-checkbox">
                                                <li>
                                                    <label class="cb-container">
                                                        ...
                                                        <input type="checkbox">
                                                        <span class="text-md-medium">GPS Navigation System </span>
                                            ...
                                            <ul class="list-filter-checkbox">
                                                <li>
                                                    <label class="cb-container">
                                                        ...
                                                        <input type="checkbox">
                                                        <span class="text-md-medium">Child Seat </span>
                                                        <span class="checkmark"></span>
                                            ...
                                            <ul class="list-filter-checkbox">
                                                <li>
                                                    <label class="cb-container">
                                                        ...
                                                        <input type="checkbox">
                                                        <span class="text-md-medium">Additional Driver </span>
                                                        <span class="checkmark"></span>
                                            ...
                                            <ul class="list-filter-checkbox">
                                                <li>
                                                    <label class="cb-container">
                                                        ...
                                                        <input type="checkbox">
                                                        <span class="text-md-medium">Insurance Coverage </span>
                                                        <span class="checkmark"></span>
                            ...
                            <div class="item-line-booking last-item pb-0">
                                <strong class="text-md-medium neutral-1000">Subtotal</strong>
                                <div class="line-booking-right">
                                    <p class="text-xl-bold neutral-1000">$124.00</p>
                                </div>
                            </div>
                            <div class="item-line-booking last-item pb-0">
                                <strong class="text-md-medium neutral-1000">Sale discount</strong>
                                <div class="line-booking-right">
                                    <p class="text-xl-bold neutral-1000">$124.00</p>
                                </div>
                            </div>
